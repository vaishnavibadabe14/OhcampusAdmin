...
@Component({
  selector: 'app-faqscategory',
  templateUrl: './faqscategory.component.html',
  styleUrls: ['./faqscategory.component.scss']
})
export class FaqscategoryComponent  implements OnInit {
    ...
    addCategory(){
      ...
      this._route.navigate(['apps/faqs/addcategory']);
    }
    ...
    deleteCategory(catId){
      let cat_id = catId
        Swal.fire({
          title: 'Are you sure?',
          text: 'You want to delete FAQs category',
          icon: 'warning',
          ...
          if (result.isConfirmed) {
            this.campusService.deleteCategoryDetails(cat_id).subscribe((res) =>{
              if(res.response_message == "Success"){
                ...
                Swal.fire(
                  'Deleted!',
                  'Your FAQs category has been deleted.',
                  'success'
                );
              }
