...
@Component({
  selector: 'app-examcatergory',
  templateUrl: './examcatergory.component.html',
  styleUrls: ['./examcatergory.component.scss']
})
export class ExamcatergoryComponent  implements OnInit {
    ...
    addCategory(){
      ...
      this._route.navigate(['apps/exams/addexamcategory']);
    }
    ...
    editCategory(catId) {
     ...
     // this._route.navigate(['apps/faqs/addcategory/update/'+ cat_id]);
      this._route.navigate(['apps/exams/addexamcategory/update/'+ cat_id]);
    }
    ...
    deleteCategory(catId){
      let cat_id = catId
        Swal.fire({
          title: 'Are you sure?',
          text: 'You want to delete Exam category',
          icon: 'warning',
          ...
          if (result.isConfirmed) {
            this.campusService.deleteCategoryDetails(cat_id).subscribe((res) =>{
              if(res.response_message == "Success"){
                ...
                Swal.fire(
                  'Deleted!',
                  'Your exam category has been deleted.',
                  'success'
                );
              }
