...
@Component({
  selector: 'app-addcarcategory',
  templateUrl: './addcarcategory.component.html',
  styleUrls: ['./addcarcategory.component.scss']
})
export class AddcarcategoryComponent  implements OnInit {
  ...
  if (routeParams.catId) {
    ...
    addCategory(){
      ...
      this.campusService.insertCategoryDetails(catname,topmenu,
        ...
        Swal.fire({
          text:  'Careers category added successful',
          icon: 'success',
          ...
          if (result.isConfirmed) {
            this._route.navigate(['apps/careers/careerscategory']);
          }
        });
        }else{
          this.addLoader = false
  ...
  updateCategory(){
    ...
    this.campusService.updateCategoryDetails(catname,topmenu,
        ...
        Swal.fire({
          text:  ' Careers category updated successful',
          icon: 'success',
          showCancelButton: false,
          confirmButtonColor: "#3290d6 !important",
          confirmButtonText: 'Ok'
